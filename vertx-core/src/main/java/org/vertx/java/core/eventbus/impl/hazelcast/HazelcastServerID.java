...
public class HazelcastServerID implements DataSerializable {
  ...
  private static final Logger log = LoggerFactory.getLogger(HazelcastServerID.class);
  ...
  public void writeData(DataOutput dataOutput) throws IOException {
	log.info("!!!!!!!!!!!!! writeData " + serverID.port + " " + serverID.host + " " + serverID.advertisePort + " " + serverID.advertiseHost);
    dataOutput.writeInt(serverID.advertisePort);
    dataOutput.writeUTF(serverID.advertiseHost);
  }
