...
public class DefaultEventBus implements EventBus {
  ...
  public DefaultEventBus(VertxInternal vertx, int port, String hostname) {
    this(vertx, port, hostname, port, hostname);
  }
  
  public DefaultEventBus(VertxInternal vertx, int port, String hostname, int advertisePort, String advertiseHost) {
    this.vertx = vertx;
    this.serverID = new ServerID(port, hostname, advertisePort, advertiseHost);
  ...
  private class ConnectionHolder {
    ...
    void connect(NetClient client, final ServerID theServerID) {
    	...
    	log.info("!!!!!!!!! connect " + theServerID.port + " " + theServerID.host);
