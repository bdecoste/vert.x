...
public class DefaultVertx extends VertxInternal {
  ...
  public DefaultVertx(int port, String hostname, int advertisePort, String advertiseHost) {
    configure();
    this.eventBus = new DefaultEventBus(this, port, hostname, advertisePort, advertiseHost);
  }
